...
function UploadForm({ uploadBtnClick, progress }) {
    ...
    const onFileSelect = (file) => {
        ...
        if (file && file.size > 500000000) {
            console.log("Size is greater than 500 MB");
        ...
        <div className='text-center'>
            ...
            <div className="flex items-center justify-center w-full"
                onDragOver={(e) => {
                    e.preventDefault();
                    e.stopPropagation();
                    // Add visual indication that file can be dropped
                }}
                onDragEnter={(e) => {
                    e.preventDefault();
                    e.stopPropagation();
                ...
                <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-full h-64 border-2 border-blue-300 border-dashed rounded-lg cursor-pointer bg-blue-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
            ...
            {progress > 0 ? <ProgressBar progress={progress} /> : <button disabled={!file} className='p-2 bg-primary text-white
